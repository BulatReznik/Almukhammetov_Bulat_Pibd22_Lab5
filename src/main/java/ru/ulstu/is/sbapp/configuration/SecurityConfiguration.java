...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.headers().frameOptions().sameOrigin().and()
                ...
                .antMatchers(HttpMethod.GET, "/orderr").authenticated()
                .antMatchers(HttpMethod.GET, "/consignment").authenticated()
                .antMatchers(HttpMethod.GET, "/request").authenticated()
                /*.antMatchers("/customer/**").hasAnyRole(ADMIN.name())
                .antMatchers("/orderr/**").hasAnyRole(ADMIN.name())
                .antMatchers("/consignment/**").hasAnyRole(ADMIN.name())
                */
